<template name="zy-search">
	<view>
		<view class="search">
			<!-- #ifdef APP-PLUS -->
				<image src="../../static/voice.svg" mode="aspectFit" @click="startRecognize()" class="voice-icon"></image>
			<!-- #endif -->
			...
			<image src="../../static/search.svg" mode="aspectFit" @click="searchStart()" class="search-icon"></image>
		</view>
